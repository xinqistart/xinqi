...
var N = (function() {
  function l(n, e, t, r) {
    ...
    function o(a) {
      ...
      } else a.startsWith("#") ? i.rgba = l.hexToRgb(a) : i.rgba = l.nameToRgb(a) || l.hexToRgb(a);
    }
    if (n !== void 0) if (Array.isArray(n)) this.rgba = n;
    else if (t === void 0) {
      var c = n && "" + n;
      c && o(c.toLowerCase());
    } else this.rgba = [n, e, t, r === void 0 ? 1 : r];
  }
  return R(l, [{ key: "printRGB", value: function(e) {
  ...
  return R(l, [{ key: "add", value: function(e, t, r) {
    e.addEventListener(t, r, false), this._events.push({ target: e, type: t, handler: r });
  } }, { key: "remove", value: function(e, t, r) {
  ...
  } }], [{ key: "_doRemove", value: function(e, t, r) {
...
var K = (function() {
  function l(n) {
    O(this, l), this.settings = { popup: "right", layout: "default", alpha: true, editor: true, editorFormat: "hex", cancelButton: false, defaultColor: "#0cf" }, this._events = new z(), this.onChange = null, this.onDone = null, this.onOpen = null, this.onClose = null, this.setOptions(n);
  }
  return R(l, [{ key: "setOptions", value: function(e) {
    var t = this;
    if (!e) return;
    var r = this.settings;
    function i(s, p, f) {
  ...
  } }, { key: "_setHSLA", value: function(e, t, r, i, o) {
    o = o || {};
