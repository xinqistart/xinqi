import { A as T, R as B, K as O, q as _, S as L, b1 as R, _ as $, r as P, c as U, o as z, b as m, h as u, e as h, z as b, a_ as k } from "./index-DAdfXJ2i.js";
...
import { a as A } from "./agreementconfig-D5PH4kdV.js";
import "./index-Qlhkq_mt.js";
import "./configeditor-CYxVeM-q.js";
const I = { components: { BaseEditor: C }, setup() {
  const { proxy: n } = T(), e = B({ form: {}, tableData: [], dicData: [], page: { total: 0, currentPage: 1, pageSize: 20, ascs: [], descs: [] }, defaults: { agreementType: { dicData: [] } }, paramsSearch: {}, tableLoading: false, tableOption: A }), i = O().permissions, o = _(() => ({ addBtn: !!i["upms:agreementconfig:add"], delBtn: !!i["upms:agreementconfig:del"], editBtn: !!i["upms:agreementconfig:edit"], viewBtn: !!i["upms:agreementconfig:get"] }));
  function r(a, t) {
  ...
  function p(a, t) {
    a = R(a), e.paramsSearch = a, e.page.currentPage = 1, r(e.page, a), t();
  }
  function s(a) {
  ...
  function D() {
    F("agreement_type_platform").then((a) => {
      e.dicData = a.data || [];
    });
  }
  function S() {
  ...
  return { ...L(e), beforeOpen: y, permissions: i, permissionList: o, getPageF: r, handleDel: f, handleUpdate: c, handleSave: l, searchChange: p, sortChange: s, agreementTypeNote: v, refreshChange: g };
} };
function q(n, e, i, o, r, f) {
  const c = C, l = P("avue-crud"), p = k;
  return z(), U("div", null, [m(p, null, { default: u(() => [m(l, { ref: "crud", modelValue: n.form, "onUpdate:modelValue": e[1] || (e[1] = (s) => n.form = s), page: n.page, "onUpdate:page": e[2] || (e[2] = (s) => n.page = s), defaults: n.defaults, "onUpdate:defaults": e[3] || (e[3] = (s) => n.defaults = s), data: n.tableData, "before-open": o.beforeOpen, permission: o.permissionList, "table-loading": n.tableLoading, option: n.tableOption, onOnLoad: o.getPageF, onRefreshChange: o.refreshChange, onRowUpdate: o.handleUpdate, onRowSave: o.handleSave, onRowDel: o.handleDel, onSortChange: o.sortChange, onSearchChange: o.searchChange }, { agreementType: u((s) => [h("div", null, b(s.row.$agreementType) + " [" + b(o.agreementTypeNote(s.row.agreementType)) + "] ", 1)]), "agreementContent-form": u((s) => [h("div", null, [m(c, { value: n.form.agreementContent, "onUpdate:value": e[0] || (e[0] = (g) => n.form.agreementContent = g), disabled: s.disabled }, null, 8, ["value", "disabled"])])]), _: 1 }, 8, ["modelValue", "page", "defaults", "data", "before-open", "permission", "table-loading", "option", "onOnLoad", "onRefreshChange", "onRowUpdate", "onRowSave", "onRowDel", "onSortChange", "onSearchChange"])]), _: 1 })]);
}
const Q = $(I, [["render", q]]);
export {
  Q as default
